...
- (void) awakeFromNib {
    ...
    value = CFPreferencesCopyValue(CFSTR("SubTitleWarning"), CFSTR("com.Swift.LoginPlugin.VerifyAuthPlugin"), kCFPreferencesAnyUser, kCFPreferencesCurrentHost);
    ...
    // Initialize the Remote Logging Option String
    value = CFPreferencesCopyValue(CFSTR("SubTitleEnforced"), CFSTR("com.Swift.LoginPlugin.VerifyAuthPlugin"), kCFPreferencesAnyUser, kCFPreferencesCurrentHost);
    if (value && CFGetTypeID(value) == CFStringGetTypeID()) {
    ...
    // Initialize the Remote Logging Option String
    value = CFPreferencesCopyValue(CFSTR("BannerHelpDesk"), CFSTR("com.Swift.LoginPlugin.VerifyAuthPlugin"), kCFPreferencesAnyUser, kCFPreferencesCurrentHost);
    if (value && CFGetTypeID(value) == CFStringGetTypeID()) {
    ...
    value = CFPreferencesCopyValue(CFSTR("BannerDim"), CFSTR("com.Swift.LoginPlugin.VerifyAuthPlugin"), kCFPreferencesAnyUser, kCFPreferencesCurrentHost);
